...
public class M_Usuario {
    ...
    public M_Usuario IniciarSesion() {
    ...
    public M_Usuario ConsultaUsuarioId(int Identificador) {
        ConexionBD c = new ConexionBD();
        M_Usuario u = null;
    ...
    public ArrayList<M_Usuario> ListarUsuarios() {
        ConexionBD c = new ConexionBD();
        //creo arraylist de usuarios
        ArrayList<M_Usuario> usuarios = new ArrayList<M_Usuario>();
    ...
    public void ActualizarUsuario() {
        ...
        sql += "TipoDeUsuario = '" + this.TipoDeUsuario + "', ";
